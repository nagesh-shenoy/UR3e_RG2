...
get_filename_component(_filename "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2.srv" NAME_WE)
add_custom_target(_ur_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur_control" "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2.srv" "std_msgs/Float64"
)

get_filename_component(_filename "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2_Grip.srv" NAME_WE)
add_custom_target(_ur_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur_control" "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2_Grip.srv" ""
)
...
### Generating Services
_generate_srv_eus(ur_control
  "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2.srv"
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/std_msgs/cmake/../msg/Float64.msg"
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ur_control
)
_generate_srv_eus(ur_control
  "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2_Grip.srv"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_eus(ur_control
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ur_control
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(ur_control_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(ur_control_generate_messages ur_control_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2.srv" NAME_WE)
add_dependencies(ur_control_generate_messages_eus _ur_control_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2_Grip.srv" NAME_WE)
add_dependencies(ur_control_generate_messages_eus _ur_control_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(ur_control_geneus)
add_dependencies(ur_control_geneus ur_control_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ur_control_generate_messages_eus)
...
### Generating Services
_generate_srv_nodejs(ur_control
  "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2.srv"
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/std_msgs/cmake/../msg/Float64.msg"
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ur_control
)
_generate_srv_nodejs(ur_control
  "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2_Grip.srv"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_nodejs(ur_control
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ur_control
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(ur_control_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(ur_control_generate_messages ur_control_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2.srv" NAME_WE)
add_dependencies(ur_control_generate_messages_nodejs _ur_control_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/nash/ur3erg2_ws/src/ur_control/srv/RG2_Grip.srv" NAME_WE)
add_dependencies(ur_control_generate_messages_nodejs _ur_control_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(ur_control_gennodejs)
add_dependencies(ur_control_gennodejs ur_control_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ur_control_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ur_control)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ur_control
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(ur_control_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ur_control)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ur_control
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(ur_control_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ur_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ur_control\")")
  # install generated code
  install(
