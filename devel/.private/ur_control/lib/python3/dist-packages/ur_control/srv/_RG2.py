...
class RG2Request(genpy.Message):
  ...
  _full_text = """#std_msgs/Bool open_close
...
float64 data"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.target_width.data,) = _get_struct_d().unpack(str[start:end])
      return self
...
float64 data"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.current_width.data,) = _get_struct_d().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
